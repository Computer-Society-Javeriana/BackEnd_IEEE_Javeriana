    ...
    <div className="page-container">
      <div className="detail-content" style={{ marginTop: "2rem" }}>
        <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginBottom: "1rem" }}>
          <span className={`badge ${esProximo ? "badge-warning" : "badge-primary"}`}>
        ...
        {evento.lugar && (
          <div style={{ marginTop: "2.5rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", flexWrap: "wrap", gap: "0.5rem" }}>
              <h2 style={{ fontSize: "1.3rem", margin: 0, color: "var(--color-text-main)" }}>📍 Ubicación en Mapa</h2>
              <a
        ...
        <div style={{ marginTop: "3rem", display: "flex", gap: "1rem" }}>
          <Link to="/eventos" className="btn btn-outline">← Volver a eventos</Link>
          {evento.capitulo && (
            <Link to={`/capitulos/${evento.capitulo.idCapitulo}`} className="btn btn-primary">
